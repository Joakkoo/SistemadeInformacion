...
max_len = max(len(word_list) for word_list, _ in documents)
...
# Convierte training en una lista de tuplas en lugar de una lista de listas
training = [(np.array(bag), np.array(output_row)) for bag, output_row in training]

# Divide la lista de tuplas en train_x y train_y
train_x, train_y = zip(*training)

# Convierte train_x y train_y en arreglos NumPy
